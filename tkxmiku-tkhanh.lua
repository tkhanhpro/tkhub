...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/tkhanhpro/tkhub/refs/heads/main/Main/Source.lua")))();
...
_G.Settings = {
	...
	Setting = {
		...
		["Gun Mastery Skill Z"] = false,
		["Gun Mastery Skill X"] = fslse,
